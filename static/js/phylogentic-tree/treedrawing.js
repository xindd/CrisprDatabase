...
var Display = (function (newAttr) {
   ...
   // }}}
    ...
    function newNodeText(pos, string, baseline, offset) {
        ...
        var homoname = string.split('|');
        var homoH = homoname[0].split('_');
        // console.log(homoH.indexOf('H'))
        if(homoH.indexOf('H')==-1){
            text.setAttribute('fill', 'red')
        }else {
            text.setAttribute('fill', 'blue')
        }
        var a = document.createElementNS(NS,'a');
        a.setAttributeNS('http://www.w3.org/1999/xlink','xlink:href','/VSR/browse_detail/'+ homoname[1]);
        a.setAttributeNS('http://www.w3.org/1999/xlink','xlink:title','click ' + homoname +' to detail');
